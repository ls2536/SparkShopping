package com.example.wangyaoguang1218.utils;

import android.util.Log;

import com.example.wangyaoguang1218.core.LogInterceptor;
...
public class Utils {
    ...
    public static String postFile(String url, String[] name, String[] value, String[] fileParamName, File file){
        ...
        if (file!=null){
            ...
            requestBody.addFormDataPart(String.valueOf(fileParamName), "jpg", body);
        }
        if (name!=null) {
            for (int i = 0; i < name.length; i++) {
